...
EasyStar.js = function () {
    ...
    function checkAdjacentNode(instance, searchNode, x, y, cost)
    {
        ...
        {
            const node = coordinateToNode(instance, adjacentCoordinateX,
    ...
    // Helpers
    function isTileWalkable(collisionGrid, acceptableTiles, x, y, sourceNode)
    {
    ...
    function coordinateToNode(instance, x, y, parent, cost)
    {
